...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 111.70
  #define DEFAULT_bedKi 22.32
  #define DEFAULT_bedKd 372.71
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 20, 70 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -28, -2, -2.4f }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M600L50"
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT (Y_CENTER - 2)  // Y point for Z homing
#endif
